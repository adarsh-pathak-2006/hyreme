...
exports.MessageThreadModel = void 0;
...
const messageThreadSchema = new mongoose_1.Schema({
    ...
    candidateId: { type: mongoose_1.Schema.Types.ObjectId, ref: "CandidateProfile", required: true },
...
exports.MessageThreadModel = mongoose_1.default.models.MessageThread || mongoose_1.default.model("MessageThread", messageThreadSchema);
