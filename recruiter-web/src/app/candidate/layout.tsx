...
export default function CandidateLayout({
  ...
  return (
    <AuthGuard allowRole="candidate">
      <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(218,191,255,0.4),_transparent_24%),radial-gradient(circle_at_top_right,_rgba(144,122,214,0.14),_transparent_18%),linear-gradient(180deg,_#f7f4ff_0%,_#eef0ff_100%)] px-3 pt-3 pb-28 sm:px-4 sm:pt-4 sm:pb-32 md:px-6 md:pt-6 lg:pb-6">
